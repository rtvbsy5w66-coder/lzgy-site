...
export default function NewPostPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    newsCategoryId: "",
    subcategory: "",
    publishDate: new Date().toISOString().split('T')[0], // Mai dátum alapértelmezett
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Hiba történt a bejegyzés létrehozása során");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Beállítjuk a feltöltött kép URL-jét
    ...
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Új bejegyzés létrehozása</h1>
          <p className="text-gray-600 mt-2">Hozz létre egy új hírt vagy blogbejegyzést</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              placeholder="Rövid összefoglaló a bejegyzésről (megjelenik a listákban)..."
            />
          </div>
